...
/* EthernetFrame_isVLANTagged determines whether or not the provided
EthernetFrame has been VLAN-tagged according to IEEE 802.1Q. */
...
/* EthernetFrame_getEthernetType figures out what the "EtherType" field of the
provided EthernetFrame is and returns it. */
...
/* EthernetFrame_getPayloadPointer figures out where the "Payload" field of the
provided Ethernet Frame is and returns a pointer to it. */
